...
public class AdminActivity extends AppCompatActivity {
    String id_seleksi;
    CardView cvpanitia, cvkriteria, cvpendaftar, cvperangkingan, cvhasil, cvgrafik;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cvpanitia = (CardView) findViewById(R.id.cvpanitia);
        ...
        final Intent intentkeluar = new Intent(this,PanitiaActivity.class);
        cvpanitia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intentkeluar.putExtra(TAG_ID_SELEKSI, id_seleksi);
                startActivity(intentkeluar);
            }
        });

        final Intent intentkriteria = new Intent(this,KriteriaActivity.class);
        ...
        final Intent intentpendaftar = new Intent(this,PendaftarSeleksi.class);
        ...
        final Intent intentperangkingan = new Intent(this,PerangkinganSeleksi.class);
