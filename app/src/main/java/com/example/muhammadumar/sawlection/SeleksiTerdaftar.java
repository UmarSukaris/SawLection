...
public class SeleksiTerdaftar extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String TAG = SeleksiTerdaftar.class.getSimpleName();

    private static String url_select = Server.URL + "peserta/seleksi-peserta.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AdapterSeleksi(SeleksiTerdaftar.this, itemList);
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, View view,
                ...
                dialog = new AlertDialog.Builder(SeleksiTerdaftar.this);
                ...
                dialog.setItems(dialogitem, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch (which) {
                            case 0:
                                Intent intent = new Intent(SeleksiTerdaftar.this, PesertaActivity.class);
