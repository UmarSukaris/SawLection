...
public class SeleksiPeserta extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String TAG = SeleksiPeserta.class.getSimpleName();

    private static String url_select = Server.URL + "peserta/list-seleksi.php";
    private static String url_daftar = Server.URL + "peserta/daftar.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.seleksi_peserta);
        ...
        adapter = new AdapterSeleksi(SeleksiPeserta.this, itemList);
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, View view,
                ...
                final CharSequence[] dialogitem = {"Daftar"};
                dialog = new AlertDialog.Builder(SeleksiPeserta.this);
    ...
    private void daftar(final String idx) {
        String url  = url_daftar;
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Toast.makeText(SeleksiPeserta.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
                        adapter.notifyDataSetChanged();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(SeleksiPeserta.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        }) {
