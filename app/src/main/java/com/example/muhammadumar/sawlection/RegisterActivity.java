...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText txt_nim, txt_nama, txt_username, txt_password, txt_confirm_password;
    Intent intent;
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (conMgr.getActiveNetworkInfo() != null
                        && conMgr.getActiveNetworkInfo().isAvailable()
                        && conMgr.getActiveNetworkInfo().isConnected()) {
                    checkRegister(nim, nama, username, password, confirm_password);
                } else {
    ...
    private void checkRegister(final String nim, final String nama, final String username, final String password, final String confirm_password) {
