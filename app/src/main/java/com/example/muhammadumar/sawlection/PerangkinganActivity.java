...
public class PerangkinganActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perangkingan);
        ...
        adapter = new AdapterRangking(PerangkinganActivity.this, itemList);
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, final View view, final int position, long id) {
                ...
                dialog = new AlertDialog.Builder(PerangkinganActivity.this);
    ...
    private void kosong() {
        ...
        spinner_id_pendaftar.setAdapter(null);
        spinner_id_kriteria.setAdapter(null);
        txt_nilai.setText(null);
    }

    // untuk menampilkan dialog from pengguna
    private void DialogForm(String id_rangkingx, String id_pendaftarx, String id_kriteriax, String nilaix, String button) {
        ambil_pendaftar(id_pendaftarx);
        ambil_kriteria(id_kriteriax);
        dialog = new AlertDialog.Builder(PerangkinganActivity.this);
        inflater = getLayoutInflater();
        dialogView = inflater.inflate(R.layout.form_rangking, null);
        dialog.setView(dialogView);
        dialog.setCancelable(true);
        dialog.setIcon(R.mipmap.ic_launcher);
        dialog.setTitle("Form Rangking");
        txt_id_rangking = (EditText) dialogView.findViewById(R.id.txt_id_rangking);
        txt_id_pendaftar = (EditText) dialogView.findViewById(R.id.txt_id_pendaftar);
        spinner_id_pendaftar = (Spinner) dialogView.findViewById(R.id.spin_id_pendaftar);
        ...
        dialog.setPositiveButton(button, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                id_pendaftar = idpendaftar[spinner_id_pendaftar.getSelectedItemPosition()] + "";
    ...
    private void ambil_pendaftar(final String id_pendaftar) {
        // membuat request JSON
        final List<String> temp_idpendaftar, temp_nama_pendaftar;
        temp_idpendaftar = new ArrayList<String>();
        temp_nama_pendaftar = new ArrayList<String>();
        StringRequest stringRequest =new StringRequest(Request.Method.POST, url_select_pendaftar, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                // Parsing json
                try {
                    JSONArray values = new JSONArray(response);
                    idpendaftar = new String [values.length()];
                    nama_pendaftar = new String[values.length()];
                    for (int i = 0; i < values.length(); i++) {
                        JSONObject obj=values.getJSONObject(i);
                        temp_idpendaftar.add(obj.getString("id_pendaftar"));
                        temp_nama_pendaftar.add(obj.getString("nama"));

                        }
                }catch (JSONException e) {
                    e.printStackTrace();
                }
                temp_idpendaftar.toArray(idpendaftar);
                temp_nama_pendaftar.toArray(nama_pendaftar);
                // notifikasi adanya perubahan data pada adapter
                spinnerArrayAdapter = new ArrayAdapter<String>(getApplicationContext(), R.layout.list_pendaftar, nama_pendaftar);
                spinner_id_pendaftar.setAdapter(spinnerArrayAdapter);
                if (!id_pendaftar.isEmpty()) {
                    spinner_id_pendaftar.setSelection(spinnerArrayAdapter.getPosition(id_pendaftar));
                }
    ...
    private void simpan_update() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                callVolley();
                                kosong();
                                Toast.makeText(PerangkinganActivity.this,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(PerangkinganActivity.this, error.getMessage(),
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        String id_pendaftarx = jObj.getString(TAG_ID_PENDAFTAR);
                        String id_kriteriax = jObj.getString(TAG_ID_KRITERIA);
                        String nilaix = jObj.getString(TAG_NILAI);

                        DialogForm(id_rangkingx, id_pendaftarx, id_kriteriax, nilaix, "UPDATE");
                        adapter.notifyDataSetChanged();
                    } else {
                        Toast.makeText(PerangkinganActivity.this,
                                jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
