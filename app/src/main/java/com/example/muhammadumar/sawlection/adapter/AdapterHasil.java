...
public class AdapterHasil extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<DataHasil> items;

    public AdapterHasil(Activity activity, List<DataHasil> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DataHasil data = items.get(position);
